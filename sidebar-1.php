<div class="column-right">	
		...
		<?php if ( function_exists('dynamic_sidebar') && dynamic_sidebar(__('Left Sidebar','theme820')) ) : else : ?>


				<div class="widget widget_categories"><div class="widget-bg">
					<div class="title">
						<div><div><h2><?php _e('Categories','theme820'); ?></h2></div></div>
					</div>
					<div class="indent">
						<ul>
				...
				<div class="widget widget_meta"><div class="widget-bg">
					<div class="title">
						<div><div><h2><?php _e('Newsletter Sign-up','theme820'); ?></h2></div></div>
					</div>
					<div class="indent" style="padding-left:12px;">
				...
				<div class="widget widget_archive"><div class="widget-bg">
					<div class="title">
						<div><div><h2><?php _e('Archives','theme820'); ?></h2></div></div>
					</div>
					<div class="indent">
						<ul>
				...
				<div class="widget widget_meta"><div class="widget-bg">
					<div class="title">
						<div><div><h2><?php _e('Login','theme820'); ?></h2></div></div>
					</div>
					<div class="indent">
						<ul>
							<?php wp_register(); ?>
