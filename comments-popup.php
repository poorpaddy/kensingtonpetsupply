...
<body id="commentspopup" style="background:#efeddd;">
...
<?php endif; ?>
	...
	<p>
      <input class="text" type="hidden" name="comment_post_ID" value="<?php echo $id; ?>" />
	  <input class="text" type="hidden" name="redirect_to" value="<?php echo attribute_escape($_SERVER["REQUEST_URI"]); ?>" />
      <input name="submit" type="image" src="<?php bloginfo('stylesheet_directory'); ?>/images/submit.gif" id="submit" tabindex="5" value="Submit" />
